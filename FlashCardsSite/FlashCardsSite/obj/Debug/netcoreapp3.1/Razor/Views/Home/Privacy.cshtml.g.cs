#pragma checksum "C:\Users\Motop\Desktop\MEGAsync\Coding\C# Schule\MySite\FlashCardsSite\FlashCardsSite\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "039734a230fc96c05f0334d806806f92d5c7c338"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"039734a230fc96c05f0334d806806f92d5c7c338", @"/Views/Home/Privacy.cshtml")]
...
This Website uses so-called “cookies”. Cookie");
            WriteLiteral(@"s are small text files that are stored in the memory of your terminal via your browser. They store certain information (e.g. your preferred language or site settings) which your browser may (depending on the lifespan of the cookie) retransmit to us upon your next visit to our Website.
...
Of course you may use our Website without any cookies being set. In your browser, you can at any time configure or completely deactivate the use of cookies. This may, however, lead to a restriction of the functions or have adverse effects on the user-friendl");
            WriteLiteral(@"iness of our Website. You may at any time object to the setting of optional cookies by using the respective objection option indicated in the table above.
...
Google will analyze your use of this Website. To this purpose, Google uses the cookies described in more detail in the above table. The information collected by Google in connection with your use of our Website (e.g. the referring URL, our webpages visited by you, your browser type, your language settings, your operating system, your screen resolution) will be transmitted to a server of Google in the US, where it will be stored and analyzed. We and our partner Google will use this information to better tailor our advertisements to you and your interests, to limit the number of times you are shown the same advertisement, to evaluate the efficiency of promotional campaigns, and to better comprehend the behavior of visitors after they have looked at a certain ad. When you visit another website of the so-called “Google Display Network”, customized");
            WriteLiteral(@" pop-ups tailored to your interests can be presented to you on the basis of the information collected on our Website.
...
Facebook will analyze your use of this Website. To this purpose, we use the cookies described in more detail in the above table. The information collected by Facebook in connection with your use of our Website will be transmitted to a server of Facebook in the US, where it wi");
            WriteLiteral(@"ll be stored and analyzed. These information include the referring URL, your browser type, your language settings, your operating system, your screen resolution and further information depending on the implemented pixel events (e.g. “purchase”: processes the type, ID and number of the selected item as well as payment information and currency; “search”: processes the search string, when you search for a product on our website; “view content”: processes the content ID, name, type, currency and value). We and our partner Facebook will use this information to better tailor our advertisements to you and your interests, to limit the number of times you are shown the same advertisement, to evaluate the efficiency of promotional campaigns, and to better comprehend the behavior of visitors after they have looked at a certain ad. When you visit your Facebook timeline or another websites of Facebook’s advertisement network (so called “Audience Network”), customized feeds tailored to your interests can be presented to yo");
            WriteLiteral(@"u on the basis of the information collected on our Website.
...
Facebook is responsible for processing your personal data which Facebook collects directly from our Website for online behavioral advertisement services. Since we have no control over personal data collected and processed by third parties, we are not in a position to provide binding information regarding the scope and purpose of such processing of your personal data. Thus, please visit Fac");
            WriteLiteral(@"ebook’s information on data privacy to receive further information on how Facebook processes your personal data and for how long. At the time of preparation of this privacy statement, Facebook’s information was available on their Privacy Policy.
...
LinkedIn does not share the personal data with the website owner, it only provides reports (which do not identify you) about the website audience and ad performance. LinkedIn also provides retargeting for website visitors (up to 90 days after the visit), enablin");
            WriteLiteral(@"g the website owner to show personalized ads off its website by using this data, but without identifying the member. We also use data that does not identify you to improve ad relevance and reach members across devices. LinkedIn members can control the use of their personal data for advertising purposes through their account settings.
...
6. External services ");
            WriteLiteral(@"or content on our Website
...
For further information regarding the scope and purpose of such collection ");
            WriteLiteral(@"and processing of your data, please consult the privacy statements of the providers whose services and/or content we include and who are responsible for the protection of your data in this context:
...
There are further specific information that we can only share with a limited");
            WriteLiteral(@" group of people. Therefore we file the following personal data:
...
Participation in the user surveys conducted from time to time on our website is voluntary. We use functional cookies to carry out the user surveys. The technical information record");
            WriteLiteral(@"ed by the user survey is the same information that is recorded when users visit the website (see above). Your responses submitted during the user survey will not be linked to your personal data such as your IP address.
...
For the processing of your data we will to some extent use specialized service contractors. Such service contractors are carefully selected and regularly monitored by us. Based on respective data processor agreements, they will only process personal data upon our instruction and strictly in a");
            WriteLiteral(@"ccordance with our directives.
...
The following rights are in general available to you according to applicable data privacy laws:
    ...
    Right to object to a processing for reasons of our own legitimate interest, public interest, or profiling, unless we are able to proof that compelling, warranted reasons sup");
            WriteLiteral(@"erseding your interests, rights and freedom exist, or that such processing is done for purposes of the assertion, exercise or defense of legal claims;
...
D. Amendment o");
            WriteLiteral(@"f Privacy Statement
